...
namespace Puffin::IO
{
	static bool InitTextureImage(Rendering::VulkanEngine& engine, const void* pixels, const uint32_t texWidth, const uint32_t texHeight, Rendering::AllocatedImage& outImage)
	{
	...
	static bool LoadImageFromFile(Rendering::VulkanEngine& engine, fs::path texturePath, Rendering::AllocatedImage& outImage)
	{
		...
		bool result = InitTextureImage(engine, pixel_ptr, texWidth, texHeight, outImage);
