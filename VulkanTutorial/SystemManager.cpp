...
namespace Puffin
{
	namespace ECS
	{
		...
		void System::EntitySignatureChanged(Entity entity, Signature entitySignature)
		{
			// If entity signature matches system signature, add it to set
		...
		//std::shared_ptr<System> SystemManager::RegisterSystem(System system)
		//{
